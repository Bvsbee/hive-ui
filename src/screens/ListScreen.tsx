...
export default function ListScreen() {
  ...
  const { data: recentMedia, isLoading: isLoadingRecent } =
    useFetchRecentlyAddedMedia(user?.guid);
                ...
                recentMedia.map((item: any, index: number) => {
                  ...
                  return (
                    <View key={item.guid || index} style={styles.recentCard}>
                      ...
                      <Text style={styles.recentMediaTitle} numberOfLines={2}>
                        {mediaTitle}
                      </Text>
                    </View>
                  );
            ...
            {isLoading ? (
              ...
              <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>
                  You dont have any lists yet. Create one to get started!
                </Text>
              </View>
            )}
          </View>
